...
class LocationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Get = channel.unary_unary(
                '/LocationService/Get',
                request_serializer=location__pb2.GetLocationMessage.SerializeToString,
                response_deserializer=location__pb2.LocationMessageList.FromString,
                )
        self.GetNearby = channel.unary_unary(
                '/LocationService/GetNearby',
                request_serializer=location__pb2.GetNearbyMessage.SerializeToString,
                response_deserializer=location__pb2.LocationMessageList.FromString,
                )
...
class LocationServiceServicer(object):
    ...
    def GetNearby(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_LocationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Get': grpc.unary_unary_rpc_method_handler(
                    servicer.Get,
                    request_deserializer=location__pb2.GetLocationMessage.FromString,
                    response_serializer=location__pb2.LocationMessageList.SerializeToString,
            ),
            'GetNearby': grpc.unary_unary_rpc_method_handler(
                    servicer.GetNearby,
                    request_deserializer=location__pb2.GetNearbyMessage.FromString,
                    response_serializer=location__pb2.LocationMessageList.SerializeToString,
            ),
    }
...
class LocationService(object):
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/LocationService/Get',
            location__pb2.GetLocationMessage.SerializeToString,
    ...
    def GetNearby(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/LocationService/GetNearby',
            location__pb2.GetNearbyMessage.SerializeToString,
            location__pb2.LocationMessageList.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
